...
# rip the feature
# Note: The first 2.024 seconds of this MPEG2 stream seems to cause remux errors due to timing problems. This can be avoided by seeking to the first frame past this point.
DVD_TITLE=$(rip_dvd_title "DVD rips/$DVD_NAME" 1 1 "en" "$DVD_NAME" "$DVD_RELEASE_DATE" "$DVD_IMAGE" "$DVD_NAME" "$DVD_NAME" 2.040)
if [ $? -ne 0 ]
then
    exit 1
fi
