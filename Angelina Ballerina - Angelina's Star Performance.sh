...
# define variables
DVD_VOLUME_LABEL="Angelinas Star Perform"
DVD_RELEASE_DATE="11 May 2009"
...
DVD_TITLE=$(rip_dvd_title "DVD rips/$DVD_NAME" 2 1 "en" "Act I" "$DVD_RELEASE_DATE" "$DVD_IMAGE" "1. Act I" "$DVD_NAME")
if [ $? -ne 0 ]
then
    exit 1
fi
...
DVD_TITLE=$(rip_dvd_title "DVD rips/$DVD_NAME" 3 1 "en" "Act II" "$DVD_RELEASE_DATE" "$DVD_IMAGE" "2. Act II" "$DVD_NAME")
if [ $? -ne 0 ]
then
    exit 1
fi
