...
DVD_TITLE=$(rip_dvd_title "DVDs/$DVD_NAME" 2 1 "en" "Act I" "$DVD_RELEASE_DATE" "$DVD_ISO" "1. Act I" "$DVD_NAME")
if [ $? -ne 0 ]
then
    exit 1
fi
...
DVD_TITLE=$(rip_dvd_title "DVDs/$DVD_NAME" 3 1 "en" "Act II" "$DVD_RELEASE_DATE" "$DVD_ISO" "2. Act II" "$DVD_NAME")
if [ $? -ne 0 ]
then
    exit 1
fi
